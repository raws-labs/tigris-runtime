...
built but require plans generated by the compiler. The fixture generator is a
script in the compiler repository, not part of the `tigris-ml` package. From a
checkout of [raws-labs/tigris](https://github.com/raws-labs/tigris):
...
```cmake
find_package(tigris_runtime 0.11 REQUIRED CONFIG)
